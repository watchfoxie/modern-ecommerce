...
REQUIRED_ENV_VARS["auth-service"]="AUTH_MONGODB_URI,AUTH_SERVICE_USERNAME,AUTH_SERVICE_PASSWORD,JWT_SIGNING_SECRET,INTERNAL_SERVICE_TOKEN"
REQUIRED_ENV_VARS["user-service"]="USER_MONGODB_URI,USER_SERVICE_USERNAME,USER_SERVICE_PASSWORD,INTERNAL_SERVICE_TOKEN"
REQUIRED_ENV_VARS["category-service"]="CATEGORY_MONGODB_URI,CATEGORY_SERVICE_USERNAME,CATEGORY_SERVICE_PASSWORD"
REQUIRED_ENV_VARS["product-service"]="PRODUCT_MONGODB_URI,PRODUCT_SERVICE_USERNAME,PRODUCT_SERVICE_PASSWORD,INTERNAL_SERVICE_TOKEN"
REQUIRED_ENV_VARS["cart-service"]="CART_MONGODB_URI,CART_SERVICE_USERNAME,CART_SERVICE_PASSWORD,INTERNAL_SERVICE_TOKEN"
REQUIRED_ENV_VARS["notification-service"]="RABBITMQ_USERNAME,RABBITMQ_PASSWORD,INTERNAL_SERVICE_TOKEN"
REQUIRED_ENV_VARS["order-service"]="ORDER_MONGODB_URI,RABBITMQ_USERNAME,RABBITMQ_PASSWORD,INTERNAL_SERVICE_TOKEN"
REQUIRED_ENV_VARS["api-gateway"]="JWT_SIGNING_SECRET,INTERNAL_SERVICE_TOKEN"
