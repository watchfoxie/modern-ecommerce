...
public record ProductUpsertRequest(
		...
		@NotBlank @Size(min = 2, max = 180) @Pattern(regexp = "^[a-z0-9]+(?:-[a-z0-9]+)*$", message = "must be a lowercase URL slug") String slug,
		@NotBlank @Size(min = 2, max = 80) String brand,
		...
		@NotEmpty List<@NotBlank @Size(max = 512) String> imageUrls,
		@NotNull Map<@NotBlank @Size(max = 64) String, @NotBlank @Size(max = 500) String> specs,
