package md.services.product_service.connection;
...
public class CheckDatabaseConnection implements ExitCodeGenerator {
    ...
    private static final String URI_ENV_NAME = "PRODUCT_MONGODB_URI";
    private static final String DATABASE_ENV_NAME = "PRODUCT_SERVICE_DB_NAME";
    private static final String COLLECTION_ENV_NAME = "COMMON_COLLECTION_NAME";

    private int exitCode = 0;

    @Value("${PRODUCT_MONGODB_URI:}")
    private String mongodbUri;

    @Value("${PRODUCT_SERVICE_DB_NAME:}")
