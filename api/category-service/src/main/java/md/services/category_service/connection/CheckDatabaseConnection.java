package md.services.category_service.connection;
...
public class CheckDatabaseConnection implements ExitCodeGenerator {
    ...
    private static final String URI_ENV_NAME = "CATEGORY_MONGODB_URI";
    private static final String DATABASE_ENV_NAME = "CATEGORY_SERVICE_DB_NAME";
    private static final String COLLECTION_ENV_NAME = "COMMON_COLLECTION_NAME";

    private int exitCode = 0;

    @Value("${CATEGORY_MONGODB_URI:}")
    private String mongodbUri;

    @Value("${CATEGORY_SERVICE_DB_NAME:}")
