package md.services.order_service.connection;
...
public class CheckDatabaseConnection implements ExitCodeGenerator {
    ...
    private static final String URI_ENV_NAME = "ORDER_MONGODB_URI";
    private static final String DATABASE_ENV_NAME = "ORDER_SERVICE_DB_NAME";
    private static final String COLLECTION_ENV_NAME = "COMMON_COLLECTION_NAME";

    private int exitCode = 0;

    @Value("${ORDER_MONGODB_URI:}")
    private String mongodbUri;

    @Value("${ORDER_SERVICE_DB_NAME:}")
